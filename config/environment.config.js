...
module.exports = {
  ...
  SendGridListTemplateId: process.env.SENDGRID_LIST_TEMPLATE_ID,
  SendGridBaseTemplateId: process.env.SENDGRID_BASE_TEMPLATE_ID,
  UrlEmail: process.env.CORS_ORIGIN,
};
